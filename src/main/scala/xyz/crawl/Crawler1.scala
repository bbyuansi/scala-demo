...
object Crawler1 extends App {
  ...
  new Crawler1("http://www.qq.com", filter = (url: String) => url.contains(".qq.com")).crawl
...
/**
  ...
  */
class Crawler1(startPage: String,
               filter: (String => Boolean) = (url: String) => true,
               onDataLoaded: (String, Int, Array[Byte], Map[String, String]) => Any = (url: String, status: Int, data: Array[Byte], headers: Map[String, String]) => {
